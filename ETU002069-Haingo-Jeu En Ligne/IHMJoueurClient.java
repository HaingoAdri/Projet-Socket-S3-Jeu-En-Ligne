...
public class IHMJoueurClient  extends Box implements ActionListener, Observer {
	...
	private JButton caillouM= new JButton(new ImageIcon("pierre.png"));
	private JButton feuilleA = new JButton(new ImageIcon("feuille.png"));
	private JButton ciseauxA = new JButton(new ImageIcon("ciseaux.PNG"));
	private JButton caillouA= new JButton(new ImageIcon("pierre.png"));
